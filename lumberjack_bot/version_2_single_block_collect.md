https://github.com/TheDudeFromCI/mineflayer-collectblock/blob/master/examples/collector.js
[Demo](https://www.youtube.com/watch?v=5T_rcCnNnf4)

```javascript
/**
 * This bot example show how to direct a bot to collect a specific block type
 * or a group of nearby blocks of that type.
 * Doesn't require any chest nearby
 */
